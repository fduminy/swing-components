 ...
 */
abstract public class AbstractUserItemAction<B, M> extends AbstractItemAction<B, M> implements UserListAction<B> {
    /**
     ...
     */
    @Override
    protected final void doAction(ListActions<B> listener) {
